...
function buildDailySummaryHtml(forPrint) {
  ...
  const title = options.mode === "weekly" ? "Weekly Care Packet" : (options.mode === "range" ? "Care Summary" : "Daily Care Summary");
...
function getPrintOptions() {
  const mode = document.getElementById("printModeWeekly")?.checked
    ? "weekly"
    : (document.getElementById("printModeRange")?.checked ? "range" : "single");
